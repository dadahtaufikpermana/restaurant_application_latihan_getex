...
DetailProductModel detailProductModelsFromJson(String str) => DetailProductModel.fromJson(json.decode(str));

String detailProductModelsToJson(DetailProductModel data) => json.encode(data.toJson());
